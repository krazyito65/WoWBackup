...
L["barDisplay"] = "Barres"
L["barDisplayDesc"] = "simple affichage sous forme de barres." -- Needs review
...
L["iconDisplayDesc"] = "simple affichage sous forme d'icônes" -- Needs review
L["iconGroupDisplay"] = "Groupes d'icônes"
L["iconGroupDisplayDesc"] = "affiche toutes les incantations disponibles pour un sort en une seule icône." -- Needs review
...
L["logDisplayDesc"] = "simple cadre où les messages sont envoyés quand un sort est utilisé." -- Needs review
