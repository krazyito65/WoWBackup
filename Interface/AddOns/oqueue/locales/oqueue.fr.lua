...
OQ.BAD_REALID         = "Royaume-id ou battle-tag invalide.\n" ;
...
OQ.BUT_WAITLIST       = "File d'attente" ;
...
OQ.BUT_SUBMIT2MESH    = "Soumettre b-tag" ;
...
OQ.TT_LEADER          = "Chef" ;
OQ.TT_REALM           = "Royaume" ;
OQ.TT_BATTLEGROUP     = "Groupe de bataille" ;
...
OQ.SETUP_ANNOUNCE_RAGEQUIT   = "Announcer les rage quitter" ;
OQ.SETUP_OK2SUBMIT_BTAG      = "Soumettre b-tag tous les 4 jours" ;
...
OQ.DD_BAN             = "Bannir cet utilisateur battle.tag" ;
...
OQ.DLG_17             = "Entrez le battle-tag à bannir:" ;
...
OQ.NOBTAG_01          = "Informations Battle-tag non reçues à temps." ;
...
OQ.LFGNOTICE_DLG = { "",
                        ...
                        "  pour LFG or other types of personal",
