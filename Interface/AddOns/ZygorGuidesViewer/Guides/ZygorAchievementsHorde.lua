...
.talk 44852
.' Puor the third and 25 Gold for each one after that. You will need 111.1 Gold total.
.' Earn the Safe Deposit Achievement |achieve 546rchase 7 Bank Slots. These will cost 10 Silver for the first one, 1 Gold for the 2nd, 10 Gold f
step
...
.' Kill a Moccasin |achieve 2556/10 |tip They look like small snakes that crawl on the ground around this area. //TODO
// WINTERSPRING
step
...
goto 48.8,54.8
.' Kill a Crystal Spider |achieve 2556/3 |tip They look like small blue spiders on the ground around this area. //TODO
// MOUNT HYJAL
step
...
.' Love a Hare |achieve 1206/13
.' Kill an Adder |achieve 2556/1 |tip They look like small snakes on the ground around this area.  They share spawns with Hares, so kill Hares if you don't see any. //TODO
step
label "swine"
goto 48.5,15.9
...
.' Love a Gazelle |achieve 1206/12
step
label "small_frog"
goto 37.9,46.1
...
.' Love a Small Frog |achieve 1206/11
// DUSTWALLOW MARSH
step
...
.' Kill a Spider |achieve 2556/16 |tip They look like tiny spiders crawling on the ground around this area. //TODO
step
label "mouse"
goto 46.2,56.9
.' Kill a Mouse |achieve 2556/11 |tip They look like small white rats on the ground around this area. //TODO
step
label "snake"
goto 50.0,57.6
.' Kill a Snake |achieve 2556/15 |tip They look like small snakes crawling on the ground around this area. They share spawns with Toads, so kill Toads if you don't see any. //TODO
...
.' Kill a Rat |achieve 2556/12 |tip They look like small rats on the ground around this area. //TODO
step
label "roach"
goto 42.2,69.5
.' Kill a Roach |achieve 2556/13 |tip They look like small brown insects on the ground around this area. //TODO
step
label "wharf_rat"
goto 42.7,72.8
...
.' Love a Shore Crab |achieve 1206/7
// BLASTED LANDS
step
...
.' Kill a Scorpion |achieve 2556/14 |tip The look like small scorpions on the ground around this area. //TODO
step
label "fire_beetle"
goto 44.4,32.9
.' Kill a Fire Beetle |achieve 2556/5 |tip The look like small red bugs on the ground around this area. //TODO
// SWAMP OF SORROWS
step
label "travel_swamp"
...
.' Kill a Gold Beetle |achieve 2556/7 |tip They look like small tan bugs on the ground around this area.
// SEARING GORGE
step
...
.' Love a Ram |achieve 1206/16
.' Love a Squirrel |achieve 1206/1
.' Kill a Squirrel |achieve 2556/2 //TODO
// TWILIGHT HIGHLANDS
step
...
.' Kill a Maggot |achieve 2556/9 |tip They look like small plump grubs walking on the ground around this area. //TODO
// GHOSTLANDS
step
label "travel_ghostlands"
'Skipping next part of guide |next "+travel_hinterlands" |only if step:Find("+larva"):IsComplete()
'Proceeding next step |next |only if default
step
goto 32.5,58.1
.talk 43573
...
.' Kill a Larva |achieve 2556/8 |tip They look like small plump grubs walking on the ground around this area. //TODO
// BOREAN TUNDRA
step
label "travel_silvermoon"
'Skipping next part of guide |next "+travel_hinterlands" |only if step:Find("+ewe"):IsComplete() and step:Find("+borean_marmot"):IsComplete() and step:Find("+steam_frog"):IsComplete() and step:Find("+borean_frog"):IsComplete()
'Proceeding next step |next |only if default
step
goto 45.4,30.5
.talk 16189
...
step
'Go northeast into Silvermoon City |goto Silvermoon City |noway |c
step
goto Silvermoon City,58.4,21.0
...
.talk 18930
.' Fly to Shattrath, Terokkar Forest |goto Shattrath City,63.8,41.7,0.5 |noway |c
step
label "ewe"
...
.' Love a Steam Frog |achieve 1206/2
step
|fly Taunka'le Village
step
label "borean_frog"
goto 72.7,41.0
...
.' Love a Borean Frog |achieve 1206/3
// SHOLAZAR BASIN
step
label "travel_hinterlands"
...
goto 47.4,42.5
.' Kill an Underbelly Rat |achieve 2556/17 |tip They look like small dark gray mice on the ground all around in the Dalaran Sewers. //TODO
step
goto Dalaran,60.4,47.8 |n
...
.' Kill an Zul'Drak Rat |achieve 2556/18 |tip They look like small mice on the ground all around this area. //TODO
step
label "artic_hare"
goto 71.8,69.8
...
.' Kill a Fjord Rat |achieve 2556/6 |tip They look like rats on the ground around this area.  There are also regular Rats around this area, so make sure to kill an actual Fjord Rat.
step	
|fly New Agamand
step
label "fjord_penguin"
...
.' Kill a Devouring Maggot |achieve 2556/4 |tip They look like big plump grubs on the ground around this area, among a bunch of ghouls.
step
goto 56.6,49.2 |n
...
step
goto 56.1,50.8
.' Click on Icecrown and the Frozen Throne |tip It looks like a green book sitting on the edge of this wooden table. 
.' Read Icecrown and the Frozen Throne |achieve 1244/10
step
goto 56.2,51.0
.' Click on Kel'Thuzad and the Forming of the Scourge |tip It looks like a black book sitting on the edge of this wooden table.
...
step
goto 82.5,33.3 |n
.' Enter the Scarlet Monastery building |goto Scarlet Monastery |noway |c
step
goto Tirisfal Glades,85.3,32.2 |n
.' Walk into the Scarlet Monastery Library Portal |tip It looks like a swirling portal in an arched doorway.
.' Teleport into the Scarlet Monastery Library |goto 13.9,25.1,0.5 |noway |c
step
goto Scarlet Monastery,44.8,17.1
...
step
goto 59.9,12.4
.' Click on Aftermath of the Second War |tip It looks like a blue book laying on the ground.
...
step
goto 78.2,25.0
.' Click on The World Tree and the Emerald Dream |tip It looks like a green book laying on the ground.
...
step
goto 84.3,19.3
.' Click on The War of the Ancients |tip It looks like a green book laying on the corner of this table. 
...
step
goto 81.7,41.3
.' Click on The Scourge of Lordaeron |tip It looks like a black book laying on the corner of this table. 
...
step
goto Western Plaguelands,69.7,73.2 |n
.' Enter Scholomance here |goto Western Plaguelands,69.7,73.2,0.3 |noway |c
step
goto 69.3,73.2
.' Click the Scholomance Door |tip It looks like a big dark wooden and metal door.
.' Walk into the big swirling portal
.' Enter the Scholomance dungeon |goto Scholomance |noway |c
step
goto Scholomance,63.0,34.9 |n
...
step
goto 85.1,43.8
.' Click on Sargeras and the Betrayal |tip It looks like a black book in this corner of the room on a table. 
...
step
'Go outside to Western Plaguelands |goto Western Plaguelands |noway |c
step
...
step
'Go south to Badlands |goto Badlands |noway |c
step
goto Badlands,64.3,35.0
.talk 44407
...
step
goto 42.1,73.8
.' Click on Wrath of Soulflayer |tip It looks like a reddish book sitting on a bookshelf downstairs in this building.
...
goto 69.1,70.7
.talk 16227
.' Fly to Vendetta Point, Southern Barrens |goto Southern Barrens,41.6,47.7,0.5 |noway |c
step
...
goto 64.9,50.0
.' Follow the path back up
.' Leave the Caverns of Time tunnel |goto 64.9,50.0,0.5 |noway |c
step
goto 55.9,60.6
.talk 41214
...
step
#include "OrgFpath"
.' Fly to Fizzle and Pozzik's Speedbarge, Thousand Needles |goto Thousand Needles |noway |c
//|fly Fizzle and Pozzik's Speedbarge
step
goto 76.5,74.8
.talk 40832
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Dungeon Quests Completed",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Hemet Nesingwary: The Collected Quests",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\The First Rule of Ring of Blood is You Don't Talk About Ring of Blood",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\A Simple Re-Quest",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Quests Completed Achievements",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Daily Quests Completed Achievements",[[
description Complete
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Eastern Kingdoms\\Full Caravan",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Eastern Kingdoms\\Ready, Set, Goat!",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Kalimdor\\Glutton for Fiery Punishment",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Kalimdor\\Glutton for Icy Punishment",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Kalimdor\\Glutton for Shadowy Punishment",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Kalimdor\\E'ko Madness",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Kalimdor\\Joy Ride",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Outland\\Blade's Edge Bomberman",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Outland\\Bombs Away",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Northrend\\Honorary Frenzyheart",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Northrend\\Savior of the Oracles",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Northrend\\Guru of Drakuru",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Northrend\\Rapid Defense",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Northrend\\Mine Sweeper",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Northrend\\Veteran of the Wrathgate",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Help the Bombardier! I'm the Bombardier!",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Ludicrous Speeds",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\The Fiery Lords of Sethria's Roost",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Dragonmaw Tour of Duty",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\The Molten Front Offensive",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Fireside Chat",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Legacy of Leyara",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\The 'Unbeatable?' Pterodactyl: BEATEN.",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Bounce",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Fungal Frenzy",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\My Very Own Broodmother",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\And the Meek Shall Inherit Kalimdor",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Gang War",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Have... Have We Met?",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Infernal Ambassadors",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Flawless Victory",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Master of the Molten Flow",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\King of the Spider-Hill",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Death From Above",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Ready for Raiding II",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Rock Lover",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\The Glop Family Line",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\King of the Mountain",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Consumed by Nightmare",[[
description Endure the nightmares of Iso'rath in the Twilight Highlands. 
condition end achieved(5451)
step
.' For this achievement, you'll want to complete our Twilight Highlands quests guide.
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\Vision of Vashj'ir Past",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Quests Achievements\\Cataclysm\\20,000 Leagues Under the Sea",[[
...
// BUY STUFF FROM AUCTION HOUSE (ADD IN LATER)
//	step
//		'From the Auction House:
//		.buy 4 Roasted Clefthoof##27658 |next "has_clefthoof"
//		.' Or...
//		.' Click this line if you would rather farm the "Roasted Clefthoof" |confirm |q 11381
//	step
//		'From the Auction House:
//		.buy 2 Mok'Nathal Shortribs##31672+
//		.buy Crunchy Serpent##31673
//		.' Or...
//		.' Click this line if you would rather farm the "Warp Burgers" |confirm |q 11377
//	step
//		'From the Auction House:
//		.buy 3 Warp Burger##27681+ |next "has_burger"
//		.' Or...
//		.' Click this line if you would rather farm the "Warp Burgers" |confirm |q 11377
// SOUP FOR THE SOUL FARMING
step
|fly Garadar |q 11381
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Profession Achievements\\Cooking\\Iron Chef",[[ //omg there are 200 recipes, right now at 203
description Learn 200 cooking recipes.
condition end achieved(5471)
//TAUGHT BY TRAINER Recipes 41 here
step
...
.learn Baked Manta Ray##45569 //25
...
.buy 1 Recipe: Smoked Sagefish##21099 //43
step
...
//1 Brilliant Smallfish Core, bristle whisker catfish
step
//alliance
...
//1 Charred Wolf Meat Core -- human or undead only, we'll see
//1 Crispy Bat Wing Core --horde only
step
...
//1 Herb Baked Egg Core --get from start maybe
//1 Roasted Boar Meat Core --get from start maybe
//1 Slitherskin Mackerel Core
//step
//alliance
//fly Sentinel Hill
...
//1 Roasted Moongraze Tenderloin TBC --alliance only
//step
//goto 49.8,51.8
//.talk 17110
//..accept 9454
...
//20 Scorpid Surprise Core --horde only
step
...
//25 Beer Basted Boar Ribs Core --alliance only
//step //19
...
//|confirm
//35 Roasted Kodo Meat x 2 Core --horde only
step
fly Thunder Bluff
step
...
//50 Longjaw Mud Snapper Core --for horde
step
...
//step //25
//.learn Smoked Bear Meat##8607 |use Recipe: Smoked Bear Meat##6892	
//50 Loch Frenzy Delight Core --alliance only
//step //28
...
.learn Slitherskin Mackerel##7752 |use Recipe: Slitherskin Mackerel##6326
//50 Strider Stew x 2 Core -- horde only
step
...
//60 Thistle Tea Core -- Rogue only, dammit
//60 Crunchy Spider Surprise TBC -- alliance way
//step
...
//75 Westfall Stew Core -- for HORDE
step
...
//85 Cooked Crab Claw Core --for horde only
step
...
//85 Savory Deviate Delight Core
step
//both
...
//90 Dig Rat Stew x 2 Core --no longer in game
//110 Big Bear Steak Core
step
//both
...
//110 Succulent Pork Ribs Core --for horde only
step
...
//130 Curiously Tasty Omelet Core -- horde only
step
...
step
.learn Spiced Chili Crab##15915 |use Recipe: Spiced Chili Crab##16111
//150 Heavy Crocolisk Stew Core --horde only
step
...
//150 Tasty Lion Steak Core -- no longer in game
//175 Giant Clam Scorcho Core
step
fly Ratchet	
step
goto Northern Barrens,70.1,73.3 |n
...
.learn Sagefish Delight##25954 |use Recipe: Sagefish Delight##21219
//175 Soothing Turtle Bisque Core -- no longer in game
//200 Goldthorn Tea x 4 Core -- tested, works
step
//both
...
//225 Undermine Clam Chowder x 2 Core --alliance only
//step
//fly Booty bay
//step
//goto 42.6,72.8
...
//275 Runn Tum Tuber Surprise Core -- in diremaul
step
...
//285 Smoked Desert Dumplings Core
step
//both
fly Cenarion Hold
step
...
//300 Dirge's Kickin' Chimaerok Chops x 5 Core --no longer in game
//TBC Recipes 16 here
//300 Buzzard Bites TBC
step
title +The Burning Crusade Recipes
...
.buy 1 Recipe: Lightly Fried Lurker##65412 |only if skill("Cooking")>=450
.buy 1 Recipe: Seasoned Crab##65413 |only if skill("Cooking")>=450
.buy 1 Recipe: Starfire Espresso##65414 |only if skill("Cooking")>=450 //75
.buy 1 Recipe: Feathered Lure##65408 |only if skill("Cooking")>=450
.buy 1 Recipe: Highland Spirits##65415 |only if skill("Cooking")>=450
.buy 1 Recipe: Lurker Lunch##65416 |only if skill("Cooking")>=450
step
...
.learn Fortune Cookie##88019 |use Recipe: Fortune Cookie##65432 |only if skill("Cooking")>=525
.learn South Island Iced Tea##88044 |use Recipe: South Island Iced Tea##65433 |only if skill("Cooking")>=525
//SPECIAL Recipes 18 here
//325 Spicy Hot Talbuk TBC
step
...
.learn Stormchops##43758 |use Recipe: Stormchops##33871
.learn Delicious Chocolate Cake##43779 |use Recipe: Delicious Chocolate Cake##33925
//hot apple cider, gingerbread cookie, egg nog
step
...
//bread of the dead --look up capital citygraveyards
step
...
//spice bread stuffing,, pumpkin pie, candied sweet potato, cranberry chutney, slow-roasted turkey
step
'This recipe is learned during the Pilgrim's Week holiday
//alliance
//goto Elywnn Forest,34.0,51.6
//.talk 35337
...
//Seafood mag + broiled dragon feast
step
...
.buy 1 Recipe: Seafood Magnifique##62800 //98
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Profession Achievements\\Fishing\\Northrend Angler Angler",[[
description Catch a fish in specific nodes
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Profession Achievements\\Fishing\\Fish or Cut Bait: Undercity",[[ //Undercity
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Profession Achievements\\Fishing\\Fish or Cut Bait: Thunder Bluff",[[ //Thunder Bluff
description Complete each of the Undercity fishing daily quests. 
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Achievements Guides\\Profession Achievements\\Fishing\\Fish or Cut Bait: Orgrimmar",[[ //Orgrimmar
...
.' Catch a Raw Sagefish. |achieve 5478/35
...
.' Catch a Sharptooth. |achieve 5478/37
step
...
.' Catch a Sickly Looking Fish. |achieve 5478/39
step
goto 71.7,25.4
...
.' Catch a Plated Armorfish. |achieve 5478/34
...
step
 ...
 .' Catch a Zangarian Sporefish. |achieve 5478/43
 ...
 .' Catch a Spotted Feltail. |achieve 5478/41
...
.' Catch a Sewer Carp. |achieve 5478/36
step
goto 33.8,43.0 |n
...
.' Catch a Slippery Eel. |achieve 5478/40
.' Catch a Shimmering Minnow. |achieve 5478/38
step
