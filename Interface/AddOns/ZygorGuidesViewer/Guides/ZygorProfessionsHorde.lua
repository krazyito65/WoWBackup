...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Alchemy\\Alchemy 1-525 Leveling Guide",[[
...
path	69.1,56.4	56.9,73.9	48.8,62.7
path	46.6,43.8	57.5,47.0	66.6,46.2
#include follow_path_herbs
...
path	73.6,31.7	50.7,74.5	28.5,63.7
path	44.3,76.8	44.3,76.8	19.9,34.9
path	9.0,70.2
#include follow_path_herbs
...
step
#include "port_blastedlandslands"
step
label "farm"
'Skipping 1st part of farming |next "+farm2" |only if step:Find("+farming"):IsComplete()
'Proceeding to farm |next |only if default
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Archaelogy\\Archaeology 1-525 Leveling Guide",[[
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Blacksmithing\\Blacksmithing 1-525 Leveling Guide",[[
...
next "bla_1-75_skill"
// GATHER:  95 Rough Stone, 385 Copper Ore
step
label "bla_1-75_farm"
#include vendor_Blacksmithing
...
step
#include "maincity_anvil"
.create Silver Bar##2658,Mining,5 total |n
...
step
|fly Shattrath
// CREATE:  5 Lesser Rune of Warding, 5 Fel Iron Breastplate, 10 Adamantite Cleaver, 7 Lesser Ward of Shielding
step
...
path	57.6,36.2	52.6,34.5	52.8,44.8
...
'Use the Orgrimmar Cooking Dailies guide section to complete Cooking dailies until you have gathered 3 Chef's Awards |confirm
step
...
step
label "cook_450_500_skill"
#include "cast_campfire"
.create 31 Whitecrest Gumbo##65406,Cooking,475
step
goto 56.9,62.7
.talk 49737
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Cooking\\Cooking Dailies\\Orgrimmar Cooking Dailies",[[
author support@zygorguides.com
...
.' You can find more around [51.2,46.4]
.' You can find more around [40.8,46.6]
.' You can find more around [47.0,59.1]
.' You can find more around [49.4,68.3]
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Cooking\\Cooking Dailies\\Dalaran Cooking Dailies",[[
author support@zygorguides.com
...
'Proceeding to farm |next |only if default
step
goto Orgrimmar 50.6,56.2 |n
.' Take the zeppelin to Tirisfal Glades |goto Tirisfal Glades |noway |c
step
|fly Ruins of Southshore
step
label "farming"
goto 52.1,74.8
.from Daggerspine Shorehunter##2369+, Daggerspine Siren##2371+
.collect Iridescent Pearl##5500 |use
step
label "farm3"
'Skipping 3rd part of farming |next "+exit" |only if step:Find("+farming"):IsComplete()
'Proceeding to farm |next |only if default
...
step
#include OrgFpath
.' Fly to Gadgetzan, Tanaris |goto Tanaris |noway |c
step
label "farming"
goto 54.5,40.3
...
'1.  Cast the enchantments on Enchanting Vellum. This will allow you to sell the enchantments on the Auction House to recoup some of your costs.  You can buy the Vellums from Kithas at [Orgrimmar,53.3,48.9]
'
...
#include "go_farm",skill="Enchanting",req="1",goto="ench_426_525_farm"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Engineering\\Engineering 1-525 Leveling Guide",[[
...
.' Zoom your minimap all the way out, track minerals, and gather ore from yellow mineral spots on your minimap
.' Go to this point in the farming path
#include "follow_path_mine"
skill Mining,255
...
step
#include "trainer_Engineering"
.learn Felsteel Stablizer##30309
step
#include "maincity_anvil"
...
// GATHER: 180 Obsidium Ore, 28 Volatile Earth, 72 Volatile Air, 13 Volatile Fire, 264 Elementium Ore, 100 Embersilk Cloth, 2 Dream Emerald
step
...
.collect 80 Embersilk Cloth##53010
step
#include "hearth_hub"
...
#include go_farm,skill="First Aid",req="1",goto="aid_350-450_farm"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Inscription\\Inscription 1-525 Leveling Guide",[[
...
step
.create 18 Dawnstar Ink##57706,Inscription,15 total
...
path 59.4,46.6		56.0,60.1		55.2,66.6
...
#include "follow_path_herbs"
.' You need about 200 Silvery-giving herbs total
.collect Golden Sansam##13464 |n
.collect Sorrowmoss##13466 |n
.' You'll need about {_G.max(0 , (38-itemcount(13463,13464,13467,13465,13466))*2)} more herbs.
...
step
.create 2 Glyph of Mage Armor##56984,Inscription,332
step
#include "trainer_Inscription"
...
.' You'll need about {_G.max(0 , (126-itemcount(36903,37921,39970,39969,36901,36901,36907,36904,36906,36905))*2)} more herbs in stacks of 5.
.' Mill the 255 herbs you gathered into Nether Pigment and Icy Pigment |cast Milling##51005
.collect 126 Azure Pigment##39343
...
.' Enter the Portal to Orgrimmar |goto Orgrimmar |noway|c
step
#include "auctioneer"
...
step
#include "port_hyjal"
// GATHER: 58 Ashen Pigment, 15 Burning Embers, 156 Volatile Life, 30 Volatile Water
step
...
.collect 15 Burning Embers##61980
...
path 27.5,32.3		27.8,27.0		31.2,32.0	
path 28.9,35.6		26.8,41.5
.collect 156 Volatile Life##52329 |tip You will get this collecting Cinderbloom and Heartblossom
#include "max_skill_warning",skill="Herbalism",goto="ins_425-525_farm"
step
'Skipping 3rd part of farming |next "+exit" |only if step:Find("+farming"):IsComplete()
'Proceeding to farm |next |only if default
...
goto 57.9,31.2
.from Obsidian Stoneslave##47226+
.collect 5 Volatile Earth##52327
step
goto 34.6,69.2
.from Enslaved Tempest##46328+
...
step
#include "maincity_anvil"
.create Copper Bar##2657,Mining,190 total
...
// GATHER: 10 Star Ruby, 10 Powerful Mojo, 10 Essence of Earth, 20 Huge Emerald, 20 Large Opal, 25 Citrine, 50 Mithril Bar, 50 Thorium Bar
step
...
|tip Mine Thorium Ore while you're collecting these.
step
label "exit"
#include "hearth_hub"
step
...
// CREATE: 20 Citrine Ring of Rapid Healing, 50 Thorium Setting, 10 Ruby Pendant of Fire, 20 Simple Opal Ring, 10 Onslaught Ring, 10 Emerald Lion Ring
step
...
.' Click here to go back to the farming Thorium Ore step if you don't have enough Star Ruby, Huge Emerald, or Large Opal |script ZGV:GotoStep("farm_thorium")
...
// GATHER: 18 Prismatic Black Diamond 15 Blood Garnet, 40 Adamantite Powder, 10 Primal Earth, 10 Adamantite Bar, 5 Golden Draenite
step
...
step
goto 19.7,34.7 |n
.' Enter Blackrock Mountain here |goto 19.7,34.7,0.5 |noway |c
step
goto 18.4,25.2 |n 
...
// CREATE: 15 Prismatic Black Diamond, 5 Delicate Blood Garnet, 10 Glinting Shadow Draenite, 10 Mercurial Adamantite, 10 Heavy Adamantite Ring
step
...
// CREATE: 45 Brilliant Blood Stone, 5 Bloodstone Band, 20 Stoneguard Band, 5 Dream Signet
step
...
// GATHER: 50 Carnelian, 15 Alicite, 15 Jasper, 35 Nightstone, 15 Zephyrite, 90 Hessonite
step
...
step
#include "hearth_ValleyofHonor"
// CREATE: 25 Brilliant Carnelian, 25 Hessonite Band, 20 Nightstone Choker, Fire Prisms
step
...
step
label "fire_prism"
.create Fire Prism##73478,Jewelcrafting,525 // |only if skill("Jewelcrafting")<525 - I don't think this works. If the conditions fails you won't be shown a step that you MUST do.
|tip You can only make 1 of these every 20 hours. Skip to next step to gain skills quicker. Be sure to make one of these everyday. // |only if skill("Jewelcrafting")<525 - I don't think this works. If the conditions fails you won't be shown a step that you MUST do.
.create Fire Prism##73478,Jewelcrafting,1 total // |only if skill("Jewelcrafting")>=525 - I don't think this works. If the conditions fails you won't be shown a step that you MUST do.
|tip Make one of these everyday! // |only if skill("Jewelcrafting")>=525 - I don't think this works. If the conditions fails you won't be shown a step that you MUST do.
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Jewelcrafting\\Jewelcrafting Dailies Guide",[[
description This guide will walk you through leveling your Jewelcrafting skill from 1-525.
author support@zygorguides.com
step
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Tailoring\\Tailoring 1-525 Leveling Guide",[[
...
step
goto Northern Barrens,66.0,12.5
.from Venture Co. Overseer##3286+, Venture Co. Enforcer##3283+
.collect 165 Wool Cloth##2592
.' You can find more in the cave here: [65.1,11.8]
step
#include "hearth_hub"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Leatherworking\\Leatherworking 1-525 Leveling Guide",[[
...
step
goto Orgrimmar,52.5,53.2 |n
.' Ride the Zeppelin to Northern Stranglethorn |goto Northern Stranglethorn
step
|fly Bambala
step
goto 61.0,21.2
...
// GATHER:	35 Black Dye, 92 Rune Thread, 410 Rugged Leather
//	step //57
//		#include "port_blastedlands"
//	step //58
//		|fly New Kargath
...
step
#include "hearth_ValleyofHonor"
// CREATE:	35 Nightscape Headband, 15 Nightscape Pants, 18 Rugged Armor Kit, 25 Wicked Leather Bracers, 
step
...
.' Kill any beasts you see and skin them.
.collect 1166 Borean Leather##33568 |n
skill Skinning,395
step
'Skipping next part of farming |next "+farm2" |only if step:Find("+farming"):IsComplete()
'Proceeding to farm |next |only if default
...
path 29.6,64.4
.' Kill any beasts you see and skin them.
.collect 1166 Borean Leather##33568
...
step
#include "hearth_ValleyofHonor"
// CREATE:	33 Borean Armor Kit, 10 Arctic Boots, 123 Heavy Borean Leather, 20 Dark Frostscale Leggings, 5 Overcast Bracers,
step
...
.collect 125 Heavy Borean Leather##38425 |tip Save these, you'll need these later
step
#include "trainer_Leatherworking"
...
.' Click on the Portal to Orgrimmar |goto Orgrimmar |noway |c
|only if level <=83
step
#include "port_twilight"
step
...
//...
'Redirecting to Mining finale |next "m_425-525" |only if default
step
#include "home_ValleyofStrength"
step
title + Mining (1-65)
...
step
 goto Orgrimmar,52.5,53.2 |n
.' Ride the Zeppelin to Grom'Gol Base Camp, Northern Stranglethorn |goto Northern Stranglethorn |noway |c
step
label	"farming"
map Northern Stranglethorn
...
.' Ride the Zeppelin to Tirisfal Glades |goto Tirisfal Glades |noway|c
step
.' Go south to The Undercity |goto Undercity |noway |c
step
|fly The Menders' Stead
step
label	"farming"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Profession Guides\\Mining\\Mining with Smelting 1-525 Leveling Guide",[[
