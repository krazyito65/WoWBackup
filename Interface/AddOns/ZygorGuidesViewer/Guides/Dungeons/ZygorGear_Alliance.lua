...
ZygorGuidesViewer.ItemScore.Items["Classic Dungeons\\Blackfathom Deeps"] = {
	...
	-- QUEST: BLACKFATHOM VILLIANY - ALLIANCE
	{ quest=26882, -- Blackfathom Villiany
		65938, -- Blackfathom Leggings
		65912, -- Robe of Kelris
		65986, -- Shield Against the Evil Presence
		65962, -- Thaelrid's Greaves
	},
	-- QUEST: TWILIGHT FALLS (ALLIANCE)
	{ quest=26883, -- Twilight Falls
		56699, -- Aluwyn's Legguards
		56697, -- Blackfathom Mace
		56698, -- Gift of the Enigmatic Tree
		7000, -- Heartwood Girdle
		6998, -- Nimbus Boots
	},
	-- QUEST: RESEARCHING THE CORRUPTION (ALLIANCE)
	{ quest=26884, -- Researching the Corruption
		56682, -- Band of the Skull Crusher
		56679, -- Dissector
		56681, -- Searching Wand
		56680, -- Shadestar Mace
	},
	-- QUEST: KNOWLEDGE IN THE DEEPS (ALLIANCE)
	{ quest=26885, -- Knowledge in the Deeps
		56660, -- Dusk-Stained Cloak
		56658, -- Eventide Bow
		56659, -- Gloaming Band
...
ZygorGuidesViewer.ItemScore.Items["Classic Dungeons\\Dire Maul: Gordok Commons (North)"] = {
	...
	{ quest=27125, -- King of the Gordok  -- ALLIANCE
...
ZygorGuidesViewer.ItemScore.Items["Classic Dungeons\\Abyssal Maw: Throne of the Tides - Level 80-82"] = {
	...
	{ quest={28833,28834}, -- Rescue the Earth Speaker!
		65656, -- Sea Witch Charm   --Alliance Quest -- 28834
		65655, -- Leggings of Opportune Strikes   --Alliance Quest -- 28834
		65654, -- Belt of a Thousand Deaths   --Alliance Quest -- 28834
	},
	{ quest={28836,28843}, -- SINS OF THE SEA WITCH
		65657, -- Deepmist Robes   --Alliance Quest -- 28836
		65659, -- Kelp Forest Vest   --Alliance Quest -- 28836
		65658, -- Stonespeaker's Belt   --Alliance Quest -- 28836
...
ZygorGuidesViewer.ItemScore.Items["WOTLK Dungeons\\The Nexus - Level 71-73"] = {
	...
	-- QUEST: HAVE THEY NO SHAME? (ALLAINCE)
...
ZygorGuidesViewer.ItemScore.Items["Burning Crusade Dungeons\\Hellfire Ramparts - Level 60"] = {
	...
	{quest=29528, -- Quest: War on the Ramparts
