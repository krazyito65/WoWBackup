...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Leveling Guides\\Tauren (1-13)",[[
	...
	step //125
		...
		only Tauren Druid
	step //126
		'Go northwest to Mulgore|goto Mulgore
		only Tauren Druid
	step //127
		'Go northwest to Thunder Bluff|goto Thunder Bluff
		only Tauren Druid
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Leveling Guides\\Death Knight (55-60)",[[
	...
	step //18
		...
		..accept The Power Of Blood, Frost And Unholy##12849
	step //19
		goto 51.6,34.5
...
//  only Warlock
	...
	step //145
		'Go northwest to Shadowprey Village|goto 24.1,68.2,0.1|noway|c
	step //146
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Leveling Guides\\Northrend (70-72)",[[
	...
	step //31
		goto 36.4,48.1
		.kill En'kilah Necrolords|n
		.get 5 Scourge Cage Keys|n
