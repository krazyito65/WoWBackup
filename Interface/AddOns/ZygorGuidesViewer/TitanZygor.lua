...
function TitanPanelZygorButton_OnLoad(self)
	...
	ZGV:RegisterMessage("ZYGORGV_STEP_CHANGED",TitanPanelZygorButton_ZYGORGV_STEP_CHANGED)
	ZGV:RegisterMessage("ZYGORGV_LOADING",TitanPanelZygorButton_ZYGORGV_LOADING)
end
