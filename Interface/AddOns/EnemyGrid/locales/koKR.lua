...
L["S_AGGROCOLORS"] = "어그로 별 색상"
L["S_AGGROCOLORS_DPS_AGGRO"] = "[딜] 어그로 색상"
L["S_AGGROCOLORS_DPS_AGGRO_DESC"] = "자신이 딜러 (또는 힐러)이면서 어그로를 가졌을 때 이름표를 이 색상으로 칠합니다."
L["S_AGGROCOLORS_DPS_HIGHAGGRO"] = "[딜] 높은 위협 수준 색상"
L["S_AGGROCOLORS_DPS_HIGHAGGRO_DESC"] = "자신이 어그로를 끌어 왔을 때."
L["S_AGGROCOLORS_DPS_NOAGGRO"] = "[딜] 어그로 없음 색상"
L["S_AGGROCOLORS_DPS_NOAGGRO_DESC"] = "자신이 딜러 (또는 힐러)이면서 몹이 자신을 공격하지 않을 때."
L["S_AGGROCOLORS_TANK_AGGRO"] = "[탱] 어그로 색상"
L["S_AGGROCOLORS_TANK_AGGRO_DESC"] = "자신이 탱커이면서 어그로를 가졌을 때."
L["S_AGGROCOLORS_TANK_HIGHAGGRO"] = "[탱] 높은 위협 수준 색상"
L["S_AGGROCOLORS_TANK_HIGHAGGRO_DESC"] = "다른 탱커나 그룹원에게 어그로를 빼앗길 수 있을 때."
L["S_AGGROCOLORS_TANK_NOAGGRO"] = "[탱] 어그로 없음 색상"
L["S_AGGROCOLORS_TANK_NOAGGRO_DESC"] = "자신이 탱커이고 몹이 자신을 공격하지 않을 때."
L["S_AGGROCOLORS_TANK_NOCOMBAT"] = "[탱] 비 전투 중 색상"
L["S_AGGROCOLORS_TANK_NOCOMBAT_DESC"] = "자신이 전투 중이면서 적이 자신이나 파티원과 전투 중이지 않을 때."
L["S_ALPHA"] = "투명도"
L["S_ANCHOR"] = "고정 위치"
