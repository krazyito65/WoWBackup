tempdmgshowvar=1
function psdamageshow_wod1(play,ar1,ar2,ar3)
...
function psdamagerep_wod1(chat,play,ar1,ar2,ar3,reptype,quant,zapusk, endcombat)
...
function psdamageshow_wod1_allmerge(play,ar1,ar2,ar3,bosstitle,addemptyline)
  local uron=psiccdmgfrom
  local psstrochka=""
  local ret=0
