	...
	args = {
		...
		BlessingOfSalvation = {
			...
			args = {
				...
				Local = {
					...
					order = 1,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Local
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Local = value
					end,
				},
				Whisper = {
					type = "toggle",
					...
					order = 2,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Whisper
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Whisper = value
					end,
				},
				CustomChannelEnabled = {
					type = "toggle",
					...
					order = 3,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.CustomChannel.Enabled
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.CustomChannel.Enabled = value
					end,
				},
				CustomChannelName = {
					type = "input",
					...
					order = 4,
					hidden = function()
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.CustomChannel.Enabled == false
					end,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.CustomChannel.Channel
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.CustomChannel.Channel = value
					end,
				},
				Raid = {
					type = "toggle",
					...
					order = 5,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Raid
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Raid = value
					end,
				},
				Party = {
					type = "toggle",
					...
					order = 6,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Party
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Party = value
					end,
				},
				SmartGroup = {
					type = "toggle",
					...
					order = 7,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.SmartGroup
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.SmartGroup = value
					end,
				},
				Say = {
					type = "toggle",
					...
					order = 8,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Say
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Say = value
					end,
				},
				Yell = {
					type = "toggle",
					...
					order = 9,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Yell
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Yell = value
					end,
				},
				---- Custom Message ----
				Title2 = {
				...
				Start = {
					...
					order = 28,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Messages.Start
					end,
					set = function(info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Messages.Start = value
					end,
				},
				End = {
					type = "input",
					...
					order = 32,
					get = function(info)
						return RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Messages.End
					end,
					set = function(info, value)
						RSA.db.profile.Paladin.Spells.BlessingOfSalvation.Messages.End = value
					end,
				},
			},
		},
		...
		FinalStand = {
			...
			args = {
				...
				FinalStandDisable = {
					type = "toggle",
					name = L["Disable Divine Shield Announcement."], desc = L.Paladin_FinalStand,
					order = 1,
					width = "full",
					get = function(info)
						RSA.FinalStandCheck()
						return RSA.db.profile.Paladin.Spells.FinalStand.FinalStandDisable
					end,
					set = function (info, value)
						RSA.db.profile.Paladin.Spells.FinalStand.FinalStandDisable = value
					end,
				},
