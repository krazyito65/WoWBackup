...
-- PALADIN SPECIFIC OPTION
L["Disable Divine Shield Announcement."] = true
L.Paladin_FinalStand = "Prevents RSA from announcing Divine Shield when you have the Final Stand talent. If this is enabled without you having Final Stand, Divine Shield will respect your settings for it and announce as expected."
...
L.DescStatueOfTheBlackOx = "The message played when the spell is cast on the statue of the black ox."
L.DescInterruptSuccess = "The message played when your interrupt is successful."
-- Onload Messages
...
-- General spell descriptions
L["Feasts"] = true
L["Cauldrons"] = true
L["Jeeves/Scrapbots"] = true
L["Blingtrons"] = true
L["Portable mailbox"] = true
-- Hunter spell descriptions
L["Pet: Battle resurrection"] = true