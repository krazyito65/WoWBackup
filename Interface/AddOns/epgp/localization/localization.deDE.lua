...
L["Extras Percent should be a number between 0 and 100"] = "Der Extras-Prozentwert sollte eine Zahl zwischen 0 und 100 sein" -- Needs review
L["GP: %d"] = true
...
L["Paste import data here"] = "Daten zum Importieren hier einfügen" -- Needs review
...
L["Sets the announce medium EPGP will use to announce EPGP actions."] = "Wählt das Medium, welches EPGP verwendet wird um EPGP Aktionen anzukündigen" -- Needs review
...
L["%s is not eligible for EP awards"] = "%s ist nicht für EP Belohnungen berechtigt" -- Needs review
