...
addon.hiddenOptions = {
	...
	["reducedLagTolerance"] = { prettyName = "Reduced Lag Tolerance", description = OPTION_TOOLTIP_REDUCED_LAG_TOLERANCE, type = "boolean" },
	...
	["MaxSpellStartRecoveryOffset"] = { prettyName = "Max Spell Start Recovery Offset", description = "Determines how far ahead of the \'end of a spell\' start-recovery spell system can be, before allowing spell request to be sent to the server. Ie this controls the built-in lag for the ability queuing system. Ideally, you\'ll want to set this to your in-game latency. Note: For this cvar to work, reducedLagTolerance must be enabled.", type = "number" },
