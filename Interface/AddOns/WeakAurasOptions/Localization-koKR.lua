...
L["Offer a guided way to create auras for your class"] = "자신의 클래스를 위한 오라를 쉽게 만들 수 있는 방법을 제공합니다"
L["% of Progress"] = "% 진행"
L["Okay"] = "확인"
L["On Hide"] = "숨겨질 때"
L["On Init"] = "초기 실행 시"
...
L["Outline"] = "외곽선"
L["Own Only"] = "내 것만"
L["Paste text below"] = "아래 문자를 붙여넣으세요"
L["Play Sound"] = "소리 재생"
...
L["Spark"] = "불꽃"
L["Spark Settings"] = "불꽃 설정"
L["Spark Texture"] = "불꽃 무늬"
