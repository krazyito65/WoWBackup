...
rscignorezonedef={{1026},{"Hellfire Citadel"}}
...
if rscignorezone10==nil then
	rscignorezone10={{},{}}
	for i=1,#rscignorezonedef[1] do
		table.insert(rscignorezone10[1],rscignorezonedef[1][i])
		table.insert(rscignorezone10[2],rscignorezonedef[2][i])
	end
...
if #rscignorezone10[1]>0 then
	for ug=1,#rscignorezone10[1] do
		if rscignorezone10[1][ug]==curZone then
