			...
			maintab = {
				...
				args = {
					...
					eclipse = {
						...
						desc = L["ECLIPSE_DESC"],
						width = "double",
						hidden = function() if (GetSpecialization() ~= 1) then return true else return false end end, 
						disabled = function(info) return not DB.resourcebar["enabled"] end,
						get = function(info) return DB.resourcebar[info[#info] ] end,
						set = function(info, value) DB.resourcebar[info[#info] ] = value;JSHB.Options:LockDown(JSHB.SetupResourceBarModule) end,
					},
					...
					spacer13 = { order = 13, type = "description", name = " ", desc = "", width = "full"},
					shottimer = {
						type = "toggle",
						order = 14,
					...
					spacer34 = { order = 34, type = "description", name = " ", desc = "", width = "full" },
					powercolored = {
						type = "toggle",
						order = 36,
					...
					spacer40 = { order = 40, type = "description", name = " ", desc = "", hidden = function(info) return (not DB.resourcebar.classcolored) end },
					barcolor = {
						type = "color",
						order = 42,
						name = L["Normal color"],
