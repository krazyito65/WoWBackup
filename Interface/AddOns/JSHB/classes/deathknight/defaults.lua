...
JSHB.defaults = {
	profile = {
		...
		indicators = {
			presence_onlycombat = false,
			presence_enable = true,
			presence_matchbaralpha = true,
			presence_iconsize = 30,
			presence_enablebackdrop = false,
			presence_colorbackdrop = false,
			presence_backdropcolor = { 0, 0, 0, .5 },
			presence_backdroptexture = "Solid",
			presence_backdropoffsets = { -2, 2, 2, -2 },
			presence_enableborder = false,
			presence_bordercolor = { 1, 1, 1, 1 },
			presence_bordertexture = "None",
			presence_backdropinsets = { -2, -2, -2, -2 },
			presence_edgesize = 16,
			presence_tile = false,
			presence_tilesize = 16,
			presence_enabletexcoords = false,
			presence_texcoords = { 0.08, 0.92, 0.08, 0.92 },
			anchor_presence = { "CENTER", nil, "CENTER", 160, -170 },
		},
		timers = {
			timerbar1 = {
				enabled = true,
