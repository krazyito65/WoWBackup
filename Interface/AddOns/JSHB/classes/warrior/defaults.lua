...
JSHB.defaults = {
	profile = {
		...
		indicators = {
			stance_onlycombat = false,
			stance_enable = true,
			stance_matchbaralpha = true,
			stance_iconsize = 30,
			stance_enablebackdrop = false,
			stance_colorbackdrop = false,
			stance_backdropcolor = { 0, 0, 0, .5 },
			stance_backdroptexture = "Solid",
			stance_backdropoffsets = { -2, 2, 2, -2 },
			stance_enableborder = false,
			stance_bordercolor = { 1, 1, 1, 1 },
			stance_bordertexture = "None",
			stance_backdropinsets = { -2, -2, -2, -2 },
			stance_edgesize = 16,
			stance_tile = false,
			stance_tilesize = 16,
			stance_enabletexcoords = false,
			stance_texcoords = { 0.08, 0.92, 0.08, 0.92 },
			anchor_stance = { "CENTER", nil, "CENTER", 160, -170 },
		},
		timers = {
			timerbar1 = {
				enabled = true,
