...
JSHB.defaults = {
	profile = {
		...
		indicators = {
			shield_onlycombat = false,
			shield_enable = true,
			shield_matchbaralpha = true,
			shield_iconsize = 30,
			shield_enablebackdrop = false,
			shield_colorbackdrop = false,
			shield_backdropcolor = { 0, 0, 0, .5 },
			shield_backdroptexture = "Solid",
			shield_backdropoffsets = { -2, 2, 2, -2 },
			shield_enableborder = false,
			shield_bordercolor = { 1, 1, 1, 1 },
			shield_bordertexture = "None",
			shield_backdropinsets = { -2, -2, -2, -2 },
			shield_edgesize = 16,
			shield_tile = false,
			shield_tilesize = 16,
			shield_enabletexcoords = false,
			shield_texcoords = { 0.08, 0.92, 0.08, 0.92 },
			anchor_shield = { "CENTER", nil, "CENTER", 160, -170 },
		},
		timers = {
			timerbar1 = {
				enabled = true,
