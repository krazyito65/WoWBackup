		...
		if JSHB.db.profile.timers[key].enabled and (#JSHB.db.profile.timers[key].timers > 0) then
			...
			JSHB.F.TimerSets[index]:SetScript("OnUpdate", 
				function(self, elapsed)
					...
					elseif JSHB.db.profile.timers[key].mountoverride and (IsMounted() or UnitHasVehicleUI("player") ) and (UnitBuff("player", "Telaari Talbuk") == nil) and (UnitBuff("player", "Frostwolf War Wolf") == nil) and (UnitBuff("player", "Rune of Grasping Earth") == nil) then
