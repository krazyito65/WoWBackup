...
GnosisCharConfig = {
	...
	["cbconf"] = {
		["GCD-player copy"] = {
			...
			["bShowLat"] = true,
			["anchor"] = {
				["px"] = 0.507812393759383,
				["py"] = 0.455285596492176,
			},
			["bEnShadowCol"] = true,
			["bInvDir"] = true,
			["anchorframe"] = "",
		...
		["Player"] = {
			...
			["bShowLat"] = true,
			["anchor"] = {
				["px"] = 0.507812568102959,
				["py"] = 0.455285699806895,
			},
			["bEnShadowCol"] = true,
			["colLagBar"] = {
				0.780392156862745, -- [1]
	...
	["channeledspells"] = {
		...
		["Crackling Jade Lightning"] = {
			...
			["bicon"] = true,
			["ticks"] = 4,
			["ctstring"] = "dmg col<100,100,0>(spellname) [tickscrits]col<pre>clipped dps DPScliptext<(Clipped) >hittext< Hits>crittext< Crits>ticktext< Ticks>",
			["bhidenonplayer"] = false,
			["baddticks"] = false,
			["binit"] = false,
			["ben"] = true,
