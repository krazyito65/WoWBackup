	...
	["CUSTOM_DEBUFF"] = {
		...
		["STORED_SETTINGS"] = {
			...
			["Slow"] = {
				...
				["isAliveTime"] = false,
				["timer"] = true,
				["SOUND"] = "Interface\\AddOns\\BigWigs\\Sounds\\Alert.ogg",
