...
xCTSavedDB = {
	["profileKeys"] = {
		...
		["Krazyito - Burning Blade"] = "Krazyito - Mal'Ganis",
		...
		["Krazýito - Gnomeregan"] = "Krazyito - Mal'Ganis",
		["Krãzyito - Gnomeregan"] = "Krãzyito - Gnomeregan",
		["Krazyitó - Mal'Ganis"] = "Krázýító - Gnomeregan",
			...
			["spells"] = {
				...
				["merge"] = {
					...
					[159238] = {
						...
						["interval"] = 3.5,
						["class"] = "ITEM",
						["desc"] = "Mark of the Shattered Hand (Weapon Enchant)",
					},
					[113344] = {
						["enabled"] = true,
						["class"] = "WARRIOR",
