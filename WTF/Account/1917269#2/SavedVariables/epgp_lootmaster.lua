...
EPGPLootMaster = {
	...
	["profiles"] = {
		["Krazymonk - Gnomeregan"] = {
			...
			["detectedRaidLookups"] = {
				["25-man instances"] = {
					["Throne of Thunder (25 Player (Heroic))"] = "Throne of Thunder^6^25",
					["Firelands (25 Player (Heroic))"] = "Firelands^6^25",
					["Icecrown Citadel (25 Player (Heroic))"] = "Icecrown Citadel^6^25",
				},
				["5-man heroic"] = {
					["Scholomance (Heroic)"] = "Scholomance^2^5",
					["Temple of the Jade Serpent (Heroic)"] = "Temple of the Jade Serpent^2^5",
				},
				["10-man instances"] = {
		...
		["Krazyito - Mal'Ganis"] = {
			...
			["detectedRaidLookups"] = {
				["25-man instances"] = {
					["Dragon Soul (25 Player (Heroic))"] = "Dragon Soul^6^25",
				...
				["5-man heroic"] = {
					...
					["Bloodmaul Slag Mines (Heroic)"] = "Bloodmaul Slag Mines^2^5",
